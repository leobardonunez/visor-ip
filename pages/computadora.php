...
<table class="table table-striped">
    ...
    foreach ($ip_computadora as $datos) {
        ...
        <tr>
            ...
            <?php if ((new CheckComputadora())->pingCpu($datos['caja1'])) {
                ?>
                <th>
            ...
            <?php } else {
                echo '<th><span class="badge bg-danger">' . $datos['caja1'] . '</span></th>';
            }
            ?>


            <?php if ((new CheckComputadora())->pingCpu($datos['caja2'])) {
                ?>
                <th>
                    <span class="badge" style="background-color:gray;">
            ...
            <?php } else {
                echo '<th><span class="badge bg-danger">' . $datos['caja2'] . '</span></th>';
            }
            ?>
            <?php if ((new CheckComputadora())->pingCpu($datos['caja3'])) {
                ?>
                <th>
                    <span class="badge" style="background-color:gray;">
            ...
            <?php } else {
                echo '<th><span class="badge bg-danger">' . $datos['caja3'] . '</span></th>';
            }
            ?>
